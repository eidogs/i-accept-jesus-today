    ...
    <section sx={styles.banner} id="home">
      <Container sx={styles.banner.container}>
        <Box sx={styles.banner.contentBox}>
          ...
          <Flex>
            <>
              <Button variant="whiteButton" aria-label="I Accept Jesus" onClick={() => setModalIsOpen(true)}>
                I Accept Jesus
              </Button>
              <Modal         
                isOpen={modalIsOpen}
                ...
                style={customStyles}
                contentLabel="I Accept Jesus"
              >
                <Heading as="h2" variant="hero">Just say this payer</Heading>
